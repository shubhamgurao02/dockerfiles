...
user_list=[i.upper() for i in user_list]
#print(user_list)
...
try:
    ...
    for i in failed_login.values:
        #print(i[0].split(' '))
        #break
        #k=i[0].split(' ')
        fip=i[0].split(' ')[2]
        fcode=i[0].split(' ')[8]
        fusername=i[0].split(' ')[6]
        for j in success_login.values:
            #print("j",j[0].split(' '))
            ...
            try:
                if (i[0].split(' ')[2] == j[0].split(' ')[2]) :
                    ...
                    #     print("i",i[0].split(' ')[8])
                    if int(i[0].split(' ')[8]) == 530 and int(j[0].split(' ')[8]) == 331:
                        #print("hello")
                        if '\\' in str(j[0].split(' ')[6]):
                            fname=j[0].split(' ')[6]
                            fname=fname.split('\\')
                            #print(fname)
                            if str(fname[1].upper()) not in user_list:
                                print(fname[1])
                            #print(i[0].split(' ')[2], "and","username",j[0].split(' ')[6],"port",i[0].split(' ')[8])
                                fail_user_details=[i[0].split(' ')[2],j[0].split(' ')[6],i[0].split(' ')[8]]
                                fail_data.append(fail_user_details)
                            #break
                        else:
                            if str(j[0].split(' ')[6].upper()) not in user_list:
                            #print(i[0].split(' ')[2], "and","username",j[0].split(' ')[6],"port",i[0].split(' ')[8])
                                fail_user_details=[i[0].split(' ')[2],j[0].split(' ')[6],i[0].split(' ')[8]]
                                fail_data.append(fail_user_details)
            ...
            #break
                ...
                break
            try:    
                if str(i[0].split(' ')[2]) == str(j[0].split(' ')[2]) :
                    if int(i[0].split(' ')[8]) == 530 and int(j[0].split(' ')[8]) == 331:
                        #print(j[0].split(' ')[6])
                        if '\\' in str(j[0].split(' ')[6]):
                            uname=j[0].split(' ')[6]
                            uname=uname.split('\\')
                            #print(uname[1])
                            if str(uname[1].upper()) in user_list:
                                #print(uname[1])
            #print(i[0].split(' ')[2], "and valid",j[0].split(' ')[2],"username",i[0].split(' ')[6])
                                success_login_details=[i[0].split(' ')[2],j[0].split(' ')[6],i[0].split(' ')[8]]
                                login_data.append(success_login_details)
                            #break
                        else:
                            if str(j[0].split(' ')[6].upper()) in user_list:
            #print(i[0].split(' ')[2], "and valid",j[0].split(' ')[2],"username",i[0].split(' ')[6])
                                success_login_details=[i[0].split(' ')[2],j[0].split(' ')[6],i[0].split(' ')[8]]
                                login_data.append(success_login_details)
