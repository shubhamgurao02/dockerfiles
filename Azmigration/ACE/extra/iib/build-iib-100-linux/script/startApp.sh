...
if [ -z $IIB_BROKER ]
then
	echo "$IIB_BIN/mqsistartmsgflow -n $IIB_BROKER_FILE -e $IIB_EXEC_GRP -k $IIB_APP"
	$IIB_BIN/mqsistartmsgflow -n $IIB_BROKER_FILE -e $IIB_EXEC_GRP -k $IIB_APP
else
	echo "$IIB_BIN/mqsistartmsgflow $IIB_BROKER -e $IIB_EXEC_GRP -k $IIB_APP"
    $IIB_BIN/mqsistartmsgflow $IIB_BROKER -e $IIB_EXEC_GRP -k $IIB_APP
fi
