...
if [ "$1" == "build" ]
then
	ant -buildfile /buildconductor/ace/build-iib-100-linux/build.xml assembleApp -Dbars.list="$2" -Dbar.$2.applications.list="$3" -Dbar.$2.deployAsSource="true" -DpipelineEvents.url="" -DbuildLabel="" -DuserId="" -DengineId="" -DpipelineEvents.application="" -DBUILD_HOME="/builds" -DBUILD_TOOLS="/buildconductor/ace" -Dpbc.platform="ado" -DIIT_BIN="/opt/ibm/ace-12.0.3.0/tools/iibt" -DMQSI_BIN="/opt/ibm/ace-12.0.3.0/server/bin" -DCURL_BIN="/usr/bin/curl"
	antReturnCode=$?
fi
...
then
    ...
    ant -buildfile /buildconductor/ace/build-iib-100-linux/build.xml overrideAndDeployApp -Dbars.list="$2" -DIIB_EXEC_GRP="$6" -Dbar.$2.brokerFile="$BROKER_FILE" -Diib.userId="$7" -Diib.password="$8" -Dbar.$2.applications.list="$9" -Dbar.$2.properties="${10}" -DpipelineEvents.url="" -DbuildLabel="" -DuserId="" -DengineId="" -DpipelineEvents.application="" -DBUILD_HOME="/builds" -DBUILD_TOOLS="/buildconductor/ace" -Dpbc.platform="ado" -DIIT_BIN="/opt/ibm/ace-12.0.3.0/tools/iibt" -DMQSI_BIN="/opt/ibm/ace-12.0.3.0/server/bin" -DCURL_BIN="/usr/bin/curl"
	antReturnCode=$?
fi
...
then
    ...
    ant -buildfile /buildconductor/ace/build-iib-100-linux/build.xml overrideAndDeployApp -Dbars.list="$2" -DIIB_EXEC_GRP="$3" -Dbar.$2.brokerFile="$BROKER_FILE" -Diib.userId="$4" -Diib.password="$5" -Dbar.$2.applications.list="$6" -Dbar.$2.properties="$7" -DpipelineEvents.url="" -DbuildLabel="" -DuserId="" -DengineId="" -DpipelineEvents.application="" -DBUILD_HOME="/builds" -DBUILD_TOOLS="/buildconductor/ace" -Dpbc.platform="ado" -DIIT_BIN="/opt/ibm/ace-12.0.3.0/tools/iibt" -DMQSI_BIN="/opt/ibm/ace-12.0.3.0/server/bin" -DCURL_BIN="/usr/bin/curl"
	antReturnCode=$?
fi
...
then
    ...
    ant -buildfile /buildconductor/ace/build-iib-100-linux/build.xml overrideAndDeployApp -Dbars.list="$2" -DIIB_EXEC_GRP="$5" -Dbar.$2.brokerFile="$BROKER_FILE" -Diib.userId="$6" -Diib.password="$7" -Dbar.$2.applications.list="$8" -Dbar.$2.properties="$9" -DpipelineEvents.url="" -DbuildLabel="" -DuserId="" -DengineId="" -DpipelineEvents.application="" -DBUILD_HOME="/builds" -DBUILD_TOOLS="/buildconductor/ace" -Dpbc.platform="ado" -DIIT_BIN="/opt/ibm/ace-12.0.3.0/tools/iibt" -DMQSI_BIN="/opt/ibm/ace-12.0.3.0/server/bin" -DCURL_BIN="/usr/bin/curl"
	antReturnCode=$?
fi
